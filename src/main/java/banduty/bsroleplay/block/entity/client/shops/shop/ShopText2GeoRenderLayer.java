...
public class ShopText2GeoRenderLayer extends GeoRenderLayer<ShopBlockEntity> {

    public ShopText2GeoRenderLayer(GeoRenderer<ShopBlockEntity> entityRendererIn) {
